...
def inject_styles() -> None:
    ...
    .glass-card:hover,.product-card:hover,.vendor-card:hover {transform:translateY(-5px) rotateX(1deg); border-color:#72dba6;}.vendor-card{min-height:172px}.product-card{min-height:152px; max-width:280px; width:100%; margin:0 auto;}.product-emoji{font-size:47px;filter:drop-shadow(0 9px 7px #0003)}.muted{color:#557063;font-size:.89rem}.price{color:#d85726;font-weight:800;font-size:1.24rem;margin-top:5px}.vendor-name{font-weight:800;font-size:1.05rem;color:#173826}.rating{color:#c47700;font-weight:800}.category{min-height:88px;text-align:center;padding:12px 6px;color:#173826;font-weight:700}.category span{font-size:29px;display:block}.order-box{background:#e6fff0;border:1px solid #83d9a7;padding:17px;border-radius:18px}.login-card{min-height:175px}.stat-card{min-height:105px}.stat-value{font:800 1.85rem Fraunces,serif;color:#d85726}
